...
const saveData=async(data)=>{
    try{
        console.log(data);
    let saveData=await axios.post("http://localhost:4000/recordCreate",data,{headers:{
...
console.log({err});
    ...
    const checkEmpty=(e)=>{
       ...
       let data={caseNumber,owner,count1,count2,count3,date,project}
        saveData(data)
    }
...
<div className="row justify-content-center">
                    <div className="col-md-7">
                        <div className="card">
                            <div className="card-header "><h6>Register New Case</h6></div>
                        ...
                        {ProjectStatus?<p style={{color:"red"}}>!please choose project</p>:""}
                                    ...
                                    <div className="form-group">
                                        <button type="submit" className="btn btn-primary btn-sm btn-block" style={{width:"100%",marginTop:"10px"}}>Add</button>
                                    </div>
