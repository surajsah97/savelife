...
const EditForm03 = () => {
    ...
    useEffect(() => {
        try{
            axios.post("http://localhost:4000/findRecords",{id:id[id.length-1]},{headers:{
    ...
    console.log(Array.from(Array(Number(data)).keys()),"===========");
  ...
  return (
    ...
    <div className='float-end'>
          ...
          <Add path={"Dashboard/new-records"}/>
    ...
    <table className="table table-bordered">
      ...
      <div className="" style={{fontSize:"80%"}}>
                ...
                <td className="d-flex ">
                  ...
                  <EditBtn path={`Dashboard/edit-records/edit-data/${id[id.length-1]}`} id={el+1} />
